...
public class B03_SucesionFibonacci {
  ...
  public static void main(String[] args) {
    ...
    // t1 representa el término actual y t2 el siguiente en la lógica de
    // actualización.
    int t1 = 0, t2 = 1;

    // Bucle para generar y mostrar los 'N' primeros números de la sucesión.
    // El bucle se ejecuta 'numero' veces, una por cada término que queremos
    // mostrar.
    for (int i = 1; i <= numero; ++i) {
      // Imprime el término actual (t1).
      System.out.println(t1);

      // Calcula el siguiente término de la sucesión sumando los dos anteriores (t1 y
      // t2).
      int suma = t1 + t2;
